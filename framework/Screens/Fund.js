                        ...
                        return (
                            <View style={styles.form}>
                                ...
                                <TouchableOpacity onPress={prop.handleSubmit} style={styles.appBTN}>
                                    <Text style={{ fontSize: 16, color: "white", fontFamily: AppTheme.font.text600 }}>Continue</Text>
                                </TouchableOpacity>
                            </View>
                        )
                    }}
                            ...
                            <View style={{ marginBottom: 20 }}>
                                ...
                                <View style={{ marginTop: 20, margin: 15, }}>
                                    ...
                                    <View style={{ alignItems: 'center', marginBottom: 20, justifyContent: "space-between", flexDirection: "row" }}>
                                        ...
                                        <Text style={[styles.modalText, { color: AppTheme.color.text, fontSize: 20, fontWeight: "bold", fontFamily: null }]}>Paystack(ATM Card)</Text>
                                    </View>

                                    <View style={{ alignItems: 'center', marginBottom: 20, justifyContent: "space-between", flexDirection: "row" }}>
                                        <Text style={styles.modalText}>Fee</Text>
                                        <Text style={[styles.modalText, { color: AppTheme.color.text, fontSize: 20, fontWeight: "bold", fontFamily: null }]}>1.8%</Text>
                                    </View>

                                    <View style={{ alignItems: 'center', marginBottom: 20, justifyContent: "space-between", flexDirection: "row" }}>
                                        <Text style={styles.modalText}>Amount</Text>
                                        <Text style={[styles.modalText, { color: AppTheme.color.text, fontSize: 20, fontWeight: "bold", fontFamily: null }]}>₦{formatMoney(amount)}</Text>
                                    </View>
                                    ...
                                    <View style={{ alignItems: 'center', marginBottom: 30, justifyContent: "space-between", flexDirection: "row" }}>
                                        ...
                                        <Text style={[styles.modalText, { color: AppTheme.color.green, fontSize: 20, fontWeight: "bold", fontFamily: null }]}>₦{formatMoney(amount + ((1.8 / 100) * amount))}</Text>
                                    </View>

                                    <TouchableOpacity onPress={() => { closeModal(); navigation.navigate("Pay", { amount: amount }) }} style={styles.appBTN}>
                                        <Text style={{ fontSize: 16, color: "white", fontFamily: AppTheme.font.text600 }}>Pay Now</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                        </View>
