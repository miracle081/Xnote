...
import { db, imgStorage, storage } from '../Service/firebase';
                ...
                <ScrollView>
                    ...
                    <View style={styles.formContainer}>
                        ...
                        <TouchableOpacity onPress={editProfile}
                            ...
                            <Text style={{ fontFamily: AppTheme.font.text600, fontSize: 16, color: "white" }}>Update Profile</Text>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
            </View>
                ...
                <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.5)" }}>
                    ...
                    <View style={{ backgroundColor: "#16171D", height: 170, borderTopRightRadius: 20, borderTopLeftRadius: 20 }}>
                        ...
                        <View>
                            ...
                            <View
                                style={{
                                    borderBottomColor: AppTheme.color.primary,
                ...
                <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.5)" }}>
                    ...
                    <View style={{ backgroundColor: '#16171D', height: 500, borderTopRightRadius: 20, borderTopLeftRadius: 20 }}>
                        ...
                        <TouchableOpacity onPress={() => { previewModal(); handleUpload() }}
                            style={[styles.getStarted, { marginHorizontal: 10 }]}>
                            <Text style={{ fontFamily: AppTheme.font.text500, fontSize: 16, }}>Upload Image</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </Modal>
